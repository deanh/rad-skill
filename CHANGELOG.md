...
- Root-level `skills/`, `hooks/`, `.claude-plugin/commands/`, `.claude-plugin/agents/`, and `.claude-plugin/plugin.json` (the monolith manifest) — all functionality now lives in `plugins/` subdirectories
